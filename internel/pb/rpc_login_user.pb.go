...
func (x *LoginUserRespone) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LoginUserRespone) ProtoMessage() {}

func (x *LoginUserRespone) ProtoReflect() protoreflect.Message {
	mi := &file_rpc_login_user_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LoginUserRespone.ProtoReflect.Descriptor instead.
func (*LoginUserRespone) Descriptor() ([]byte, []int) {
	return file_rpc_login_user_proto_rawDescGZIP(), []int{1}
}

func (x *LoginUserRespone) GetUser() *User {
	if x != nil {
		return x.User
	}
	return nil
...
func (x *LoginUserRespone) GetSessionId() string {
	if x != nil {
		return x.SessionId
	}
	return ""
...
func (x *LoginUserRespone) GetAccessToken() string {
	if x != nil {
...
func (x *LoginUserRespone) GetRefreshToken() string {
	if x != nil {
...
func (x *LoginUserRespone) GetAccessTokenExpiresAt() *timestamp.Timestamp {
	if x != nil {
...
func (x *LoginUserRespone) GetRefreshTokenExpiresAt() *timestamp.Timestamp {
	if x != nil {
...
var file_rpc_login_user_proto_rawDesc = []byte{
	...
	0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x65, 0x12, 0x1c, 0x0a, 0x04, 0x75, 0x73, 0x65, 0x72,
	...
	0x72, 0x65, 0x73, 0x41, 0x74, 0x42, 0x2d, 0x5a, 0x2b, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
	0x63, 0x6f, 0x6d, 0x2f, 0x61, 0x6b, 0x2d, 0x6b, 0x61, 0x72, 0x69, 0x6d, 0x7a, 0x61, 0x69, 0x2f,
	0x62, 0x61, 0x6e, 0x6b, 0x2d, 0x61, 0x70, 0x69, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x65,
...
var file_rpc_login_user_proto_goTypes = []interface{}{
	...
	(*LoginUserRespone)(nil),    // 1: pb.LoginUserRespone
	(*User)(nil),                // 2: pb.User
	(*timestamp.Timestamp)(nil), // 3: google.protobuf.Timestamp
}
var file_rpc_login_user_proto_depIdxs = []int32{
	2, // 0: pb.LoginUserRespone.user:type_name -> pb.User
	3, // 1: pb.LoginUserRespone.access_token_expires_at:type_name -> google.protobuf.Timestamp
	3, // 2: pb.LoginUserRespone.refresh_token_expires_at:type_name -> google.protobuf.Timestamp
