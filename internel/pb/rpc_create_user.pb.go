...
func (x *CreateUserRespone) Reset() {
	*x = CreateUserRespone{}
	if protoimpl.UnsafeEnabled {
...
func (x *CreateUserRespone) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateUserRespone) ProtoMessage() {}

func (x *CreateUserRespone) ProtoReflect() protoreflect.Message {
	mi := &file_rpc_create_user_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreateUserRespone.ProtoReflect.Descriptor instead.
func (*CreateUserRespone) Descriptor() ([]byte, []int) {
	return file_rpc_create_user_proto_rawDescGZIP(), []int{1}
}

func (x *CreateUserRespone) GetUser() *User {
	if x != nil {
		return x.User
	}
	return nil
...
var file_rpc_create_user_proto_rawDesc = []byte{
	...
	0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x22, 0x31, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x61, 0x74,
	0x65, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x65, 0x12, 0x1c, 0x0a, 0x04,
	...
	0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x61, 0x6b, 0x2d, 0x6b, 0x61, 0x72, 0x69,
	0x6d, 0x7a, 0x61, 0x69, 0x2f, 0x62, 0x61, 0x6e, 0x6b, 0x2d, 0x61, 0x70, 0x69, 0x2f, 0x69, 0x6e,
	0x74, 0x65, 0x72, 0x6e, 0x65, 0x6c, 0x2f, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_rpc_create_user_proto_goTypes = []interface{}{
	...
	(*CreateUserRespone)(nil), // 1: pb.CreateUserRespone
	(*User)(nil),              // 2: pb.User
}
var file_rpc_create_user_proto_depIdxs = []int32{
	2, // 0: pb.CreateUserRespone.user:type_name -> pb.User
...
func file_rpc_create_user_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_rpc_create_user_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CreateUserRespone); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
